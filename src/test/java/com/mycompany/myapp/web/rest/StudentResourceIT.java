...
class StudentResourceIT {
    ...
    void putNewStudent() throws Exception {
        ...
        updatedStudent.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).idNumber(UPDATED_ID_NUMBER);
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.email(UPDATED_EMAIL).idNumber(UPDATED_ID_NUMBER);
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).idNumber(UPDATED_ID_NUMBER);
